...
mov sp, bp ; a pilha começa com seu topo apontado para a sua base
...
[bits 16]
carregar_kernel:
    ; lemos o kernel no disco usando a função ler_disco.asm
    ...
    mov dh, 2 ; quantidade de setpres a serem lidos no disco
    mov dl, [DRIVE_BOOT]
    call ler_disco
    ret
...
MENSAGEM_PROTECTED db "UnimarIX em 32 bits"
MENSAGEM_KERNEL db "Carregando o kernel na memoria..."
